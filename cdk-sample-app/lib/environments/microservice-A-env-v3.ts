 ...
 */
class MicroserviceA_API_Stack extends cdk.NestedStack {
 ...
 */
class MicroserviceA_DB_Stack extends cdk.NestedStack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
...
export class Microservice_A_Env extends cdk.Stack {
  constructor(scope: Construct, id: string, props: cdk.StackProps) {
    super(scope, id, props);    
    
    new MicroserviceA_API_Stack(this, 'API_Stack', props);
    new MicroserviceA_DB_Stack(this, 'DB_Stack', props);
  }
}